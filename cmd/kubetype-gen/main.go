...
import (
	...
	"github.com/kristofgyuracz/istio-tools/cmd/kubetype-gen/scanner"
)
...
func main() {
	...
	// arguments.GoHeaderFilePath = filepath.Join(args.DefaultSourceTree(), "github.com/kristofgyuracz/istio-tools/cmd/kubetype-gen/boilerplate.go.txt")
